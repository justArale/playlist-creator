        ...
        <div className="text-left">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-left sm:max-w-xl md:ml-10 md:max-w-md md:pl-4 lg:max-w-2xl xl:ml-28 xl:max-w-3xl xl:py-20">
              ...
              <Link
                to={"/generator"}
                className="border-0.5 mb-4 inline-block w-auto rounded-lg border-transparent bg-violet-900 px-6 py-4 font-bold text-white transition duration-200 hover:bg-violet-500 md:mr-6 md:w-auto md:px-8 md:py-5 md:text-xl lg:text-2xl xl:mb-0"
              >
